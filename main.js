  ...
  TESTOWANIEFLICKA = setInterval(function() {
    ...
    success: function(data) {
        ...
        xD.forEach(function(Dx) {
            ...
            var likes = Dx.node.edge_liked_by.count;
            
            console.log(likes);
            
            //if (likes > 10000) {
              //  likes = numeral(likes).format("0a");
            //} else {
                //likes = likes;
            //};
